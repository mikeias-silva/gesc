...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `tr_valida_cpf` BEFORE update ON `pessoa`
FOR EACH ROW 
BEGIN
IF(NEW.cpf = '')THEN BEGIN
END;
ELSEIF (((SELECT count(*) from pessoa where pessoa.cpf = new.cpf ) > 0)) THEN BEGIN
SIGNAL SQLSTATE '45000'  
