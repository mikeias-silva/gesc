...
--
-- Dumping data for table `historico_matricula`
--

LOCK TABLES `historico_matricula` WRITE;
/*!40000 ALTER TABLE `historico_matricula` DISABLE KEYS */;
/*!40000 ALTER TABLE `historico_matricula` ENABLE KEYS */;
UNLOCK TABLES;
