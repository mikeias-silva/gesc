function validarDadosResp(nomeresp1, datanascimentoresp1, logradouro, bairro, cpfresp1, rgresp1) {
    var permissao = true;
    ...
    var dataSelecionada = new Date(datanascimentoresp1).toDateString();
    //console.log(hoje);
    //console.log(data2);
